...
void main() {
  ...
  float propagationAdjust1 = sin(pi * remaining1/lifespan);
  float propagationAdjust2 = sin(pi * remaining2/lifespan);
  float propagationAdjust3 = sin(pi * remaining3/lifespan);
  float propagationAdjust4 = sin(pi * remaining4/lifespan);
  float propagationAdjust5 = sin(pi * remaining5/lifespan);
